# ✨ LUMINA | Elite Programming Assistant

![Python](https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54)![Streamlit](https://img.shields.io/badge/Streamlit-FF4B4B?style=for-the-badge&logo=Streamlit&logoColor=white)![Groq](https://img.shields.io/badge/Groq-f5f5f5?style=for-the-badge&logo=lightning&logoColor=orange)![UI/UX](https://img.shields.io/badge/UI/UX-Glassmorphism-blueviolet?style=for-the-badge)
...
1. **Configure sua API Key:**
  - Obtenha sua chave gratuita em [Groq Console](https://console.groq.com/).
  - Insira a chave diretamente na barra lateral da aplicação.

1. **Execute a aplicação:**

   ```bash
   streamlit run lumina_elite_assistant.py
   ```
...
- **Animações de Fade-in**: Mensagens que deslizam suavemente para a tela.

- **Glow Effects**: Indicadores de status e avatares com brilho dinâmico.

- **Tipografia Técnica**: Uso de fontes *Inter* para leitura e *Fira Code* para blocos de código.
...
<div align="center">
Desenvolvido por <strong>Guilherme Oliveira Silva</strong> 🚀  

  <em>Estudante de Análise e Desenvolvimento de Sistemas</em>
</div>
